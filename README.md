...
| ![Color and gesture sensor APDS-9960 breakout Image](https://solde.red/333002/image) |
| :----------------------------------------------------------: |
...
This repository contains all design files for Color and gesture sensor APDS-9960 breakout, organized as follows:
